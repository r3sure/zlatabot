...
async def confirm_save(callback: CallbackQuery, state: FSMContext):
    ...
    if trial_end:
        ...
        welcome = (
            ...
            f"3 дня бесплатного доступа ко всем функциям.\n"
            f"Действует до <b>{end_str}</b>\n\n"
            "В пробный период входит всё:\n"
            "💬 Чат со Златой без ограничений\n"
            "🔮 Все расклады Таро\n"
            "📅 Благоприятные дни и прогноз на месяц\n"
            "💫 Глубокая совместимость\n"
            "⭐ Личный гороскоп\n"
            "🌙 Сны — безлимитно\n\n"
            "Пробуй, знакомься с функциями. "
            "Если захочешь продолжать — оформи подписку 💎"
        )
